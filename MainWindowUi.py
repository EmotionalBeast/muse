...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_1.setGeometry(QtCore.QRect(30,10,110,30))
        self.label_1.setText("素材组：")
        self.label_1.setObjectName("label_1")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_1.setGeometry(QtCore.QRect(530,10,110,30))
        self.label_1.setText("json文件：")
        self.label_1.setObjectName("label_2")

        self.comBox_1 = QtWidgets.QComboBox()
        self.comBox_1.setGeometry(QtCore.QRect(170,10,300,30))
