...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('./images/main.png'))
        ...
        self.menuDraw = QtWidgets.QMenu(self.menuTools)
        ...
        self.action480P = QtWidgets.QAction(MainWindow)
        self.action480P.setObjectName("action480P")
        self.action720P = QtWidgets.QAction(MainWindow)
        self.action720P.setObjectName("action720P")
        self.action1080P = QtWidgets.QAction(MainWindow)
        self.action1080P.setObjectName("action1080P")
        ...
        self.menuDraw.addAction(self.action480P)
        self.menuDraw.addAction(self.action720P)
        self.menuDraw.addAction(self.action1080P)
        self.menuTools.addAction(self.menuDraw.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action480P.setText(_translate("MainWindow", "480P"))
        self.action720P.setText(_translate("MainWindow", "720P"))
        self.action1080P.setText(_translate("MainWindow", "1080P"))
